...
// No-settlement sequencer bundle — keeps only the operational FeeStrategy,
// omits BaseLayer/SettlementModule/SettlementSigner/BridgingModule so the
// sequencer never connects to Mina L1. Use when running proofs-off / no L1.
// Swap back to baseSettlementSequencerModules when wiring real settlement.
export const baseNoSettlementSequencerModules = {
  FeeStrategy: ConstantFeeStrategy,
} satisfies SequencerModulesRecord;

export const baseNoSettlementSequencerModulesConfig = {
  FeeStrategy: {},
} satisfies ModulesConfig<typeof baseNoSettlementSequencerModules>;
